...
const getRegisterUser = async (request, reply) => {
    try {
        ...
        const registerUser = await prismaClient_1.default.user.findUnique({
            where: {
                id: userId,
            },
            include: {
...
const deleteUser = async (request, reply) => {
    try {
        ...
        await prismaClient_1.default.fuelPrice.deleteMany({
            where: { userId },
        });
